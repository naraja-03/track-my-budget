...
export default function SignIn({ providers }: Props) {
  ...
  console.log("Number of providers:", Object.keys(providers).length);
          ...
          {Object.keys(providers).length === 0 ? (
            ...
            Object.values(providers).map((provider) => (
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
              >
